...
@section('content')
    ...
    <div class="container-xl px-4 mt-n10">
        <!-- Style Reference-->
        <form class="row" id="blog" action="{{ route('admin.blog.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mb-3">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        id="title" name="title" placeholder="Judul Blog" required>
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <label for="image" class="form-label">Cover Blog<span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-sm-8 mb-3">
                                    <div id="imagePreviewContainer" class="bg-light text-center mb-3"
                                        ...
                                        <p class="mb-2">Pratinjau Cover Blog</p>
