                    ...
                    <div class="col-sm-12 col-lg-4">
                        <div class="card shadow-sm rounded-bottom-0">
                            @if ($row->images->isNotEmpty())
                                <img src="{{ asset($row->images->first()->image_path) }}" class="card-img-top"
                                    alt="{{ $row->name }}">
                            @endif
                            <div class="card-body">
                                <div
                                    ...
                                    <h5 class="product-subtitle mt-0 mt-lg-2 text-justify-custom w-lg-100">Rp
                                        {{ number_format($row->price, 0, ',', '.') }} · {{ $row->luas }}m²</h5>
                                </div>
                        ...
                        <a href="{{ route('package', ['slug' => $row->slug]) }}"
